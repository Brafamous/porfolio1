    ...
    return (
        <section>
            ...
            <section className="container projects">
                <h2 className="project-headline greeting_headline">Projects</h2>
            ...
            <section className="container technologies">
                ...
                <div className="container">
                    <p className="description-p ">
                        I've worked with a range of technologies, from web-apps to mobile-apps to machine-learning technologies
                        and I've worked with a variety of languages.
                    </p>
                    {/*<ul className="tech-skill-ul">
                        <li className="tech-skill-li">
                        ...
                        <li className={'tech-skill-li'}>
                            <svg stroke="#fff" fill="#fff" stroke-width="0" version="1.1"
                                 viewBox="0 0 32 32" height="3rem" width="3rem" xmlns="http://www.w3.org/2000/svg">
                                <path d="M15.334 14.023c0 0 0-2.972 2.972-2.972h8.917c0 0 0 2.972-2.972 2.972h-8.917zM15.334 17.821c0 0 0-2.972 2.972-2.972h4.459c0 0 0 2.972-2.972 2.972h-4.459zM15.334 21.619c0 0 0-2.972 2.972-2.972h1.486c0 0 0 2.972-2.972 2.972h-1.486zM14.336 19.3v2.371h-9.559l6.158-8.399h-5.286v-2.371h9.972l-6.129 8.4z"></path>
                            </svg>
                            <div className="TechnologiesStyles__ListContainer-sc-1ccvow3-3 technology-p"><h4
                ...
                <ul className="d-flex justify-content-start">
                    <div className="row text-small">
                        <div className="col-md-6"><h4
                            className="call-header">Call</h4><a href="tel:+233271302702" className="call-link">+233 (271) 302-702</a></div>
                        <div className="col-md-6"><h4
